...
contract SecureInsuranceContract
{
    ...
    constructor(int aadhaarCardNumber,string memory sex, address bankName, int accountNumber, address insurerName,string memory policyName,address hospitalName,string memory pan, int sumAssured,int policyTerm,int paymentTerm, bool premiumPayment) {
            Buyer = msg.sender;
